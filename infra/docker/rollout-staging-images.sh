...
if public_ip:
    ...
    storage_domain = f'storage.{app_domain}'
    values.update({
        ...
        'VRATA_STORAGE_DOMAIN': storage_domain,
        ...
        'MINIO_PUBLIC_BASE_URL': f'https://{storage_domain}'
    })
