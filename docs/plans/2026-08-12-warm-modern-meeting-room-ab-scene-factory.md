...
Approved candidate architecture evidence на 2026-08-25:

- Scene Factory PR `#26`, merge `a043dd23aa8698937de6875402b076606adc5f89`, post-merge CI `32789722870` green; CI получает Candidate 01 отдельным checkout, а compiler loader читает из него только четыре Git blobs exact commit `df564befcd65cb51a345fa9d315e40cadef6e563`;
- exact Blender `4.5.12 LTS` скомпилировал shell, door/window openings, profiles и три architectural materials; components, exterior, lights и media surfaces намеренно отсутствуют;
- два независимых GLB побайтно идентичны: SHA-256 `85ff61f70d56fad104c3621aa325e3ece2fe1e47ca66eb015339884c3a69bf66`, `38536` bytes; reopen inspection SHA-256 `64587b5fa28b02560084960d4e48c28ca6706222a2b59ce940bae9d2039b0618`;
- binary-backed validator связал exact 19 nodes/meshes и 3 materials с reopen geometry: `17376` BIN bytes, `528` decoded vertices, `852` indices, `284` triangles и `176` decoded distinct referenced positions, суммированных по meshes; extensions, cameras, lights, images, textures, animations и skins отсутствуют;
- GLB остаётся внешним verification artifact и не добавлен в repository; `componentsCompiled`, `finalCandidateGlbVerified`, `releaseArtifactsCreated` и `publicationReady` остаются false.
