...
Статус: Stage 0 infrastructure, Stage 1 art-direction gate, Stage 2 patched-source digest, publisher model Git/LFS pointer identity, DINO source/metadata identity и raw DINO payload byte identity выполнены, Definition of Ready частично открыт; AI probe launch остаётся заблокирован на 2026-08-20.
